...
import { DottedSurface } from '@/components/ui/dotted-surface-optimized'
        ...
        <>
            ...
            <main className="overflow-hidden">
                ...
                <section className="min-h-screen flex items-center justify-center relative">
                    ...
                    <div className="mx-auto max-w-7xl px-6 text-center relative z-10 will-change-transform" style={{ transform: 'translate3d(0, 0, 0)' }}>
                        <AnimatedGroup
                            variants={{
                                container: {
                                    visible: {
                            ...
                            <AnimatedGroup variants={transitionVariants}>
                                ...
                                <h1
                                    className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem] will-change-transform"
                                    style={{ transform: 'translate3d(0, 0, 0)' }}>
                                    Modern Solutions for Customer Engagement
                                </h1>
                                <p
                                    className="mx-auto mt-8 max-w-2xl text-balance text-lg will-change-transform"
                                    style={{ transform: 'translate3d(0, 0, 0)' }}>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative container mx-auto px-6 gradient-border rounded-lg p-8">
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/50 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5 gradient-border')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent gradient-border">
